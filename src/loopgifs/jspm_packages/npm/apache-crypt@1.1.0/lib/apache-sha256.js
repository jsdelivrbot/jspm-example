...
var SHA256 = {
  ...
  getPassword: function(final) {
    var epass = '';
    epass += SHA256.to64((final.charCodeAt(0) << 16) | (final.charCodeAt(10) << 8) | final.charCodeAt(20), 4);
    epass += SHA256.to64((final.charCodeAt(21) << 16) | (final.charCodeAt(1) << 8) | final.charCodeAt(11), 4);
    epass += SHA256.to64((final.charCodeAt(12) << 16) | (final.charCodeAt(22) << 8) | final.charCodeAt(2), 4);
    epass += SHA256.to64((final.charCodeAt(3) << 16) | (final.charCodeAt(13) << 8) | final.charCodeAt(23), 4);
    epass += SHA256.to64((final.charCodeAt(24) << 16) | (final.charCodeAt(4) << 8) | final.charCodeAt(14), 4);
    epass += SHA256.to64((final.charCodeAt(15) << 16) | (final.charCodeAt(25) << 8) | final.charCodeAt(5), 4);
    epass += SHA256.to64((final.charCodeAt(6) << 16) | (final.charCodeAt(16) << 8) | final.charCodeAt(26), 4);
    epass += SHA256.to64((final.charCodeAt(27) << 16) | (final.charCodeAt(7) << 8) | final.charCodeAt(17), 4);
    epass += SHA256.to64((final.charCodeAt(18) << 16) | (final.charCodeAt(28) << 8) | final.charCodeAt(8), 4);
    epass += SHA256.to64((final.charCodeAt(9) << 16) | (final.charCodeAt(19) << 8) | final.charCodeAt(29), 4);
    epass += SHA256.to64((final.charCodeAt(31) << 8) | final.charCodeAt(30), 3);
    return epass;
  },
