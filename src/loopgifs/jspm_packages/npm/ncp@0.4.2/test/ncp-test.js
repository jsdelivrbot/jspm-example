...
vows.describe('ncp').addBatch({'When copying a directory of files': {
    topic: function() {
  ...
  }}).addBatch({'When copying files using filter': {
    topic: function() {
      var cb = this.callback;
  ...
  }}).addBatch({'When copying files using transform': {'it should pass file descriptors along to transform functions': function() {
