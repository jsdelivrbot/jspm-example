...
(function(process) {
  ...
  function grab() {
    ...
    names.forEach(function(name) {
      complete.path = [name], complete.schema = schema.properties[name];
    });
    return complete;
  }
  ;
  ...
  vows.describe('prompt').addBatch({"When using prompt": {"the getInput() method": {"with a simple string prompt": {
          topic: function() {
            var that = this;
          ...
          "should prompt to stdout and respond with data": function(err, input) {
        ...
        }}}}).addBatch({"When using prompt": {"the getInput() method": {"with any field that is not supposed to be empty": {"and we don't provide any input": {
            topic: function() {
              var that = this;
              helpers.stdout.once('data', function(msg) {
                that.msg = msg;
          ...
          }}}}}).addBatch({"When using prompt": {"the getInput() method": {"with a hidden field that is not supposed to be empty": {"and we provide valid input": {
            topic: function() {
              var that = this;
              helpers.stdout.once('data', function(msg) {
                that.msg = msg;
          ...
          }}}}}).addBatch({"When using prompt": {"the getInput() method": {"with a hidden field that is not supposed to be empty": {"and we don't provide an input": {
            topic: function() {
              var that = this;
              helpers.stdout.once('data', function(msg) {
                that.msg = msg;
          ...
          }}}}}).addBatch({"When using prompt": {"the getInput() method": {"with a complex property prompt": {"and a valid input": {
            topic: function() {
              var that = this;
              helpers.stdout.once('data', function(msg) {
                that.msg = msg;
          ...
          }}}}}).addBatch({"When using prompt": {"the getInput() method": {"with a complex property prompt": {"and an invalid input": {
            topic: function() {
              var that = this;
              helpers.stdout.once('data', function(msg) {
                that.msg = msg;
          ...
          }}}}}).addBatch({"When using prompt": {"the getInput() method": {"with a complex property prompt": {"with an invalid validator (array)": {
            topic: function() {
              var that = this,
                  called;
          ...
          }}}}}).addBatch({"When using prompt": {"the get() method": {"with a simple string prompt": {"that is not a property in prompt.properties": {
            topic: function() {
              var that = this;
              helpers.stdout.once('data', function(msg) {
                that.msg = msg;
            ...
            "should prompt to stdout and respond with the value": function(err, result) {
          ...
          }}}}}).addBatch({"When using prompt": {"the get() method": {"with a simple string prompt": {"that is a property name in prompt.properties": {"with a default value": {
              topic: function() {
                var that = this;
                helpers.stdout.once('data', function(msg) {
                  that.msg = msg;
            ...
            }}}}}}).addBatch({"When using prompt": {"the get() method": {"with a simple string prompt": {"that is a property name in prompt.properties": {"that expects a numeric value": {"and gets valid input": {
                topic: function() {
                  var that = this;
                  helpers.stdout.once('data', function(msg) {
                    that.msg = msg;
              ...
              }}}}}}}).addBatch({"When using prompt": {"the get() method": {"with a simple string prompt": {"that is a property name in prompt.properties": {"with a sync function validator (.validator)": {
              topic: function() {
                var that = this;
                helpers.stdout.once('data', function(msg) {
                  that.msg = msg;
            ...
            }}}}}}).addBatch({"When using prompt": {"the get() method": {"with a simple string prompt": {"that is a property name in prompt.properties": {"with a sync function validator (.conform)": {
              topic: function() {
                var that = this;
                helpers.stdout.once('data', function(msg) {
                  that.msg = msg;
            ...
            }}}}}}).addBatch({"When using prompt": {"the get() method": {"with a simple string prompt": {"that is a property name in prompt.properties": {"with a sync function before (.before)": {
              topic: function() {
                var that = this;
                helpers.stdout.once('data', function(msg) {
                  that.msg = msg;
                });
                prompt.get({properties: {fnbefore: {before: function(v) {
                        return 'v' + v;
                      }}}}, this.callback);
            ...
            }}}}}}).addBatch({"When using prompt": {"the get() method": {"skip prompt with prompt.overide": {
          topic: function() {
        ...
        }}}}).addBatch({"When using prompt": {"the addProperties() method": {
        topic: function() {
        ...
        "should add the properties to the object": function(err, obj) {
      ...
      }}}).addBatch({"When using prompt": {"the get() method": {"with old schema": {
          topic: function() {
            var that = this;
            helpers.stdout.once('data', function(msg) {
              that.msg = msg;
        ...
        }}}}).addBatch({"When using prompt": {"the history() method": {"when used inside of a complex property": {"with correct value(s)": {
            topic: function() {
          ...
          }}}}}).addBatch({"When using prompt": {"the history() method": {"when used inside of a complex property": {"with an incorrect value": {
            topic: function() {
          ...
          }}}}}).addBatch({"when using prompt": {"the get() method": {
        topic: function() {
          prompt.override = {
            xyz: 468,
            abc: 123
      ...
      }}}).addBatch({"When using prompt": {"with fancy properties": {"the get() method": {
          topic: function() {
            prompt.override = {
              UVW: 5423,
              DEF: 64235
    ...
    prop: 'test',
    response: ''
  }, {default: 'yes'})).addBatch(macros.shouldNotConfirm({
    messages: ['with a string message'],
    prop: 'test',
    response: 'N'
  })).addBatch(macros.shouldConfirm({
    ...
    prop: 'test',
    response: 'YES'
  })).addBatch(macros.shouldNotConfirm({
    messages: ['with a string message'],
    prop: 'test',
    response: 'NO'
  })).addBatch(macros.shouldConfirm({
    ...
    prop: [{message: "test"}, {message: "test2"}],
    response: ['y\n', 'y\n']
  })).addBatch(macros.shouldNotConfirm({
    messages: ['with multiple objects'],
    prop: [{message: "test"}, {message: "test2"}],
