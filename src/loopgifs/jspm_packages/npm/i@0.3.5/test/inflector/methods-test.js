...
(function() {
  ...
  cases = require('./cases');
  vows.describe('Module Inflector methods').addBatch({'Test inflector method': {
      ...
      'dasherize': {'underscored_word': function(topic) {
          var i,
              words,
              _i,
              _len,
    ...
    }}).addBatch({'Test inflector inflection methods': {
      topic: function() {
        var Inflector;
