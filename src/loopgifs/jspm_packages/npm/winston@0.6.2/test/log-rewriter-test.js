...
vows.describe('winston/logger/rewriter').addBatch({"An instance of winston.Logger": {
  ...
  }}).addBatch({"An instance of winston.Logger with explicit rewriter": {
  ...
  }}).addBatch({"An instance of winston.Logger with rewriters": {
    topic: new (winston.Logger)({
      transports: [new (winston.transports.Console)({level: 'info'})],
      rewriters: [function(level, msg, meta) {
        meta.numbers.push(1);
