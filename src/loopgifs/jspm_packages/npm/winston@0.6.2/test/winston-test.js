...
vows.describe('winston').addBatch({"The winston module": {
    topic: function() {
    ...
    "should have the correct methods defined": function() {
      ...
      ['Logger', 'add', 'remove', 'extend'].concat(Object.keys(winston.config.npm.levels)).forEach(function(key) {
    ...
    "the extend() method called on an empty object": {
  ...
  }}).addBatch({"The winston module": {"the setLevels() method": {
      topic: function() {
      ...
      "should have the proper methods defined": function() {
        ...
        ['Logger', 'add', 'remove', 'extend'].concat(newLevels).forEach(function(key) {
          assert.isFunction(winston[key]);
        });
        Object.keys(winston.config.npm.levels).filter(function(key) {
